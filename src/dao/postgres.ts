...
export class PostgreSQLPersistence implements IPersistenceFacade {
  ...
  public async initialize(client: PoolClient): Promise<void> {
  ...
  public async acquireExclusiveLock(client: PoolClient): Promise<void> {
  ...
  public async releaseExclusiveLock(client: PoolClient): Promise<void> {
